...
<body class="external-page sb-l-c sb-r-c">
            ...
            <section id="content">
                ...
                <div class="admin-form theme-info" id="login1">
                    ...
                    <div class="row mb15 table-layout">
                        ...
                        <div class="col-xs-6 va-m pln">
                            <a href="dashboard.html" title="Return to Dashboard">
                                <img src="<?php echo skin_url() ?>assets/img/logos/logo_white.png" title="AdminDesigns Logo" class="img-responsive w250">
                            </a>
                        </div>
                    ...
                    <div class="panel panel-info mt10 br-n">
                        ...
                        <form method="post" action="<?php echo $form_action ?>" id="contact">
    ...
    <!-- Page Plugins -->
    <script type="text/javascript" src="<?php echo skin_url() ?>assets/js/pages/login/EasePack.min.js"></script>
    <script type="text/javascript" src="<?php echo skin_url() ?>assets/js/pages/login/rAF.js"></script>
    <script type="text/javascript" src="<?php echo skin_url() ?>assets/js/pages/login/TweenLite.min.js"></script>
    <script type="text/javascript" src="<?php echo skin_url() ?>assets/js/pages/login/login.js"></script>
