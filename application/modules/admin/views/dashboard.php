...
<!-- Chart Plugins -->
<script type="text/javascript" src="<?php echo skin_url('vendor/plugins/highcharts/highcharts.js') ?>"></script>
<script type="text/javascript" src="<?php echo skin_url('vendor/plugins/circles/circles.js') ?>"></script>
<script type="text/javascript" src="<?php echo skin_url('vendor/plugins/raphael/raphael.js') ?>"></script>

<!-- Page Javascript -->
<script type="text/javascript" src="<?php echo skin_url('assets/js/pages/widgets.js') ?>"></script>
